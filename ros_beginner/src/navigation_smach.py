...
class target_navigation(smach.State):
    ...
    def execute(self, userdata):
        ...
        path = '/root/catkin_ws/src/ros_beginner/src/route/' + route_name + '/target' + str(self.target_count) + '.txt'
...
class goal_navigation(smach.State):
    ...
    def execute(self, userdata):
        ...
        path = '/root/catkin_ws/src/ros_beginner/src/route/' + route_name + '/goal' + str(self.goal_count) + '.txt'

...
class Navigation(smach.State):
    def __init__(self):
        ...
        while int(self.Crossroad2) >= int(self.endtxt[0])-1 or int(self.Crossroad) == int(self.Crossroad2):
            print('error!')
            self.Crossroad2 = str(input("Crossroad2: ")) #'3'
        ...
        while int(self.DetectArea) >= int(self.endtxt[0])-1 or int(self.DetectArea) == int(self.Crossroad) or int(self.DetectArea) == int(self.Crossroad2) or int(self.DetectArea) == int(self.Crossroad)-1 or int(self.DetectArea) == int(self.Crossroad)+1 or int(self.DetectArea) == int(self.Crossroad2)-1 or int(self.DetectArea) == int(self.Crossroad2)+1:
            print('error!')
            self.DetectArea = str(input("DetectArea: ")) #'3'

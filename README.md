...
ゴールを目指しながら各経由地を巡回し，予め指定した交差点・探索エリアで必要なノードを起動，それらの状況に対応する行動をさせるプログラムです．（PCLによる歩道と車道の区別や三次元障害物の検出・回避機能の実機への移植中です．）
...
# 不明領域探索
まだ未観測のエリアを検出し、そのエリアに向けてゴールポイントを設定して走行することを繰り返し、地図を作成していくというものです。
...
交差点では事前に指定したWPによって交差点領域内に入る前に一時停止，信号認識ノード起動(A_srv03.py)
 ...
 車等で遮られた場合も青になったことが認識できていない場合は停止.
